...
const int pinoBuzzer = 8; // pino onde o buzzer esta conectado
const int pinoBotao1 = 2; // pino onde o botao 1 esta conectado
const int pinoBotao2 = 13; // pino onde o botao 2 esta conectado
